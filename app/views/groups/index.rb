  ...
  def view_template
    ...
    table class: "table table-striped" do
      ...
      @groups.each do |group|
        tr do
          td { group.name }
          td { t("views.groups.index.member_count", count: group.members.active.count) }
          td { t("views.groups.index.invite_count", count: group.members.invited.count) if group.members.invited.any? }
