  ...
  class ModelDeserializer < BaseDeserializer
    def deserialize
      ...
      allowed = @params.require(:model).permit(
        ...
        :creator_id, # i18n-tasks-use t("activerecord.attributes.model.creator")
        :library_id, # i18n-tasks-use t("activerecord.attributes.model.library")
        ...
        :collection_id, # i18n-tasks-use t("activerecord.attributes.model.collection")
        :q,
        :library,
        :creator,
        :tag,
