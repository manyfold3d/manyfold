class CreatorsController < ApplicationController
  ...
  def creator_params
    if is_api_request?
      ...
      ManyfoldApi::V0::CreatorDeserializer.new(object: params[:json], user: current_user, record: @creator).deserialize
    else
      Form::CreatorDeserializer.new(params: params, user: current_user, record: @creator).deserialize
    end
  end
end
