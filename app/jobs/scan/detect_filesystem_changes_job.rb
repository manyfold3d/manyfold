...
class Scan::DetectFilesystemChangesJob < ApplicationJob
  ...
  def perform(library_id)
    ...
    status[:step] = "jobs.detect_filesystem_changes.building_filename_list"
    ...
    status[:step] = "jobs.detect_filesystem_changes.building_folder_list"
    ...
    status[:step] = "jobs.detect_filesystem_changes.creating_models"
