class Model < ApplicationRecord
  ...
  has_many :models_related_to_me, through: :reverse_relationships, source_type: "Model", source: "subject"
  ...
  def valid_preview_files
    model_files.select { |it| it.is_image? || it.is_video? || FileHandlers::F3dWasm.can_load?(it.mime_type) || FileHandlers::Three.can_load?(it.mime_type) }
  end
