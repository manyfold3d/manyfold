...
RSpec.describe Search::ModelSearchService do
  ...
  context "with a range of models" do
    before do
      ...
      create(:model, name: "bat on a mat", tag_list: ["log"], collections: [bats], notes: nil, caption: nil)
      model = create(:model, name: "bat on a hat", tag_list: ["frog"], collections: [bats], notes: nil, caption: nil)
