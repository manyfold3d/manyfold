...
RSpec.describe Integrations::Cults3d::ModelDeserializer, :cults3d_api_key do
  ...
  context "with URL that returns a 404", vcr: {cassette_name: "Integrations_Cults3d_ModelDeserializer/not_found"} do
    subject(:deserializer) { described_class.new(uri: uri) }

    let(:uri) { "https://cults3d.com/en/3d-model/tool/404benchy" }
